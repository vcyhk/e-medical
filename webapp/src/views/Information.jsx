        ...
        <div className="form">
            <form onSubmit={handlePatientFormSubmit}>
                ...
                <div className="form-field">
                    ...
                    <input type="text" name="wallet_address" id="wallet_address" value={data.wallet_address} />
                </div>
        ...
        <div className="form">
            <form onSubmit={handleDoctorFormSubmit}>
                ...
                <div className="form-field">
                    ...
                    <input type="text" name="wallet_address" id="wallet_add" onChange={handleChange} value={data.wallet_address} disabled/>
                </div>
                <div className="form-field" style={{ textAlign: 'center' }}>
                    <button type="submit" disabled={submiting}>
                        {submiting ? 'Submiting...' : 'Update Information'}
